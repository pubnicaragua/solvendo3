/*
  # Corrección completa del schema POS

  1. Crear todas las tablas necesarias
  2. Configurar RLS correctamente
  3. Insertar datos de prueba
  4. Asegurar que todas las consultas funcionen
*/
...
CREATE POLICY "Allow all for empresas" ON empresas FOR ALL USING (true);
CREATE POLICY "Allow all for sucursales" ON sucursales FOR ALL USING (true);
CREATE POLICY "Allow all for usuarios" ON usuarios FOR ALL USING (true);
CREATE POLICY "Allow all for usuario_empresa" ON usuario_empresa FOR ALL USING (true);
CREATE POLICY "Allow all for categorias" ON categorias FOR ALL USING (true);
...
CREATE POLICY "Allow all for medios_pago" ON medios_pago FOR ALL USING (true);
CREATE POLICY "Allow all for cajas" ON cajas FOR ALL USING (true);
CREATE POLICY "Allow all for aperturas_caja" ON aperturas_caja FOR ALL USING (true);
CREATE POLICY "Allow all for movimientos_caja" ON movimientos_caja FOR ALL USING (true);
CREATE POLICY "Allow all for promociones" ON promociones FOR ALL USING (true);
CREATE POLICY "Allow all for ventas" ON ventas FOR ALL USING (true);
CREATE POLICY "Allow all for venta_items" ON venta_items FOR ALL USING (true);
CREATE POLICY "Allow all for devoluciones" ON devoluciones FOR ALL USING (true);
CREATE POLICY "Allow all for devolucion_items" ON devolucion_items FOR ALL USING (true);
CREATE POLICY "Allow all for documentos_tributarios" ON documentos_tributarios FOR ALL USING (true);
...
INSERT INTO productos (id, empresa_id, codigo, nombre, descripcion, precio, destacado, activo)
VALUES 
  ('f1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PROD001', 'Ejemplo producto 1', 'Producto de ejemplo para pruebas', 34.5, true, true),
  ('f2eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PROD002', 'Ejemplo producto 2', 'Segundo producto de ejemplo', 68.5, false, true),
  ('f3eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PROD003', 'Ejemplo producto 3', 'Tercer producto de ejemplo', 34.5, true, true),
  ('f4eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PROD004', 'Ejemplo producto 4', 'Cuarto producto de ejemplo', 34.5, false, true),
  ('f5eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PROD005', 'Ejemplo producto 5', 'Quinto producto de ejemplo', 34.5, true, true),
  ('f6eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PROD006', 'Ejemplo producto 6', 'Sexto producto de ejemplo', 0, false, true)
