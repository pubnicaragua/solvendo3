...
export const CashRegisterModal: React.FC<CashRegisterModalProps> = ({  
  ...
  const handleSubmit = async () => {  
    ...
    if (!user || !sucursalId) {  
      toast.error('Usuario o sucursal no válidos')  
      return  
    }  
    ...
    try {  
      // Necesitamos obtener el ID de la caja por defecto para esta sucursal  
      // Por ahora usaremos un ID temporal, pero deberías implementar la lógica  
      // para obtener la caja correcta de la base de datos  
      const defaultCajaId = 'default-caja-id' // TODO: Implementar lógica real  
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-full w-full h-full flex flex-col">  
        ...
        <div className="flex-1 flex items-center justify-center">  
          <div className="text-center">  
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Efectivo inicial</h3>  
