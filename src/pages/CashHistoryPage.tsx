...
export const CashHistoryPage: React.FC<CashHistoryPageProps> = ({
  onClose,
}) => {
  ...
  const filteredMovements = (movements || []).filter(
    (mov) => filters.tipo === "todos" || mov.tipo === filters.tipo
  );
