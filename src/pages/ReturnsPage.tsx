...
export const ReturnsPage: React.FC = () => {
  ...
  // Obtener funciones del contexto POS
  const { loadClientes, loadProductos } = usePOS();
  ...
  useEffect(() => {
    // Cargar clientes y productos si es necesario
    if (loadClientes) loadClientes();
    if (loadProductos) loadProductos();
  ...
  }, []); // No incluimos las dependencias loadClientes/loadProductos ya que no son necesarias para el ejemplo
  // y podrían causar re-renders innecesarios
